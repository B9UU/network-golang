...
// both from and to should implement io.Reader
// and io.Writer interfaces for the proxy to work
// since we're (from -> to) and then switching
// them to check if there's any responses
func proxy(from io.Reader, to io.Writer) error {
	// checks if from and to objects satisfy
